...
import in.jhalwabois.geogpassist.utils.ConversationCallback;
import in.jhalwabois.geogpassist.utils.TranslatorUtil;
...
public class SpeechToTextConvertor implements IConvertor { 
    ...
    public SpeechToTextConvertor(ConversationCallback conversioCallaBack) {
        this.conversionCallaback = conversioCallaBack;
    } 
 
    private ConversationCallback conversionCallaback;

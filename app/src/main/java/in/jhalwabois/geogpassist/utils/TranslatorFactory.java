...
import in.jhalwabois.geogpassist.translators.IConvertor;
import in.jhalwabois.geogpassist.translators.SpeechToTextConvertor;
import in.jhalwabois.geogpassist.translators.TextToSpechConvertor;
...
public class TranslatorFactory {
     ...
     * @return
     */
    public IConvertor getTranslator(TRANSLATOR_TYPE translator_type, ConversationCallback conversionCallaback) {
